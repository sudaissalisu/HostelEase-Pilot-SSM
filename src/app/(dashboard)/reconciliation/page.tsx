  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div><h1 className="text-2xl font-bold">Reconciliation</h1><p className="text-sm text-slate-500 mt-1">Payment settlement reconciliation from AUSU.</p></div>
      ...
      <Card><CardContent className="p-6">
        {data && Object.keys(data).length > 0 ? (
          ...
          <div className="text-center text-sm text-slate-500 py-8"><BarChart3 className="h-10 w-10 mx-auto mb-2 text-slate-300" />No data available.</div>
        )}
      </CardContent></Card>
    </div>
  )
